...
bin.publish:
	...
	git push -f git@gitee.com:$(DOCKER_PREFIX)/$(DOCKER_NAME)-release.git master;\
	echo "$(shell date +'%Y-%m-%d %H:%M:%S')|完成到gitee部署";\
	open https://gitee.com/$(DOCKER_PREFIX)/$(DOCKER_NAME)-release/pages;
